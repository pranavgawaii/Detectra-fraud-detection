            ...
            <main className="overflow-hidden bg-[#0A0A0A] text-white min-h-screen">
                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div aria-hidden className="absolute inset-0 -z-10 size-full [background:radial-gradient(125%_125%_at_50%_100%,transparent_0%,#0A0A0A_75%)]" />
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative mt-12 sm:mt-16 md:mt-24 w-full">
                                ...
                                />
                                <div className="inset-shadow-white/20 bg-[#0A0A0A] relative mx-auto max-w-6xl overflow-hidden rounded-2xl border border-white/10 p-2 shadow-[0_0_80px_rgba(255,255,255,0.05)] ring-1 ring-white/10 z-20">
                                    {dashboardNode}
                                </div>
                            </div>
                        </AnimatedGroup>
